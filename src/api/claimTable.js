export default [
  {
    ...
    problem:
      "Позвонить, полный недозвон (БОЛЕЕ одного номера) / отказ от совершения вызова",
    description:
  ...
  },
  {
    ...
    description:
      "Практически не слышу собеседника, постоянно обрывается связь.",
    address: "Новокарантинная д5 к3",
    contacts: "8 (930) 666 00 77",
    problemNumber: "8 (930) 666 00 77",
    status: "waiting_info",
...
export const claimDict = {
  ...
  status: { title: "Статус", sortable: true },
